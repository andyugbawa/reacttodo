...
import { faTrash, faPenToSquare, faCheck, faFloppyDisk } from '@fortawesome/free-solid-svg-icons';
        ...
        <div>
          ...
          <ul>
            {lists.map((list, index) => (
              <div className="list-head" key={index}> {/* Use index as key for demo */}
                <li>
                  {editList === index ? (
                    <>
                      <input
                    ...
                    <div className="list-text">
                      <div className="text-content">
                        <span className={list.completed ? "completed" : ""}>
                          {list.text}
                        </span>
                      </div>
                      <div className="btn-element">
                        ...
                        <button onClick={() => editLoad(index)}>
                          <FontAwesomeIcon icon={faPenToSquare} />
                        </button>
                        <button onClick={() => completeEdit(index)}>
